 ...
 *
 * UPDATED: 06-Feb-2012 by Henry Feild to apply zoom affect to entire div
 * via the CSS zoom property.
 *
 */
                    ...
                    function(e)
                    {
                        ...
                        el.fisheyeCfg.items.each(
                            function(nr)
                            {
                                ...
                                /// CHANGES MADE ON 06-Feb-2012 by Henry Feild:
                                ///
                                // Old code -- increased the width of the element.
                                //this.style.width = el.fisheyeCfg.itemWidth + extraWidth + 'px';

                                // Calculate the zoom.
                                var zoom = (100 + 100*extraWidth / el.fisheyeCfg.itemWidth)
                                this.style.zoom =  zoom +"%";
                                // Since the zoom applies to all properties, including 'left', we need to
                                // calibrate it.
                                this.style.left = ((el.fisheyeCfg.itemWidth * nr + toAdd)* 100 / zoom) + 'px';
                                ///
                                /// END CHANGES
