...
//			echo "<script>alert(\"slideshow alert\");</script>";
		}
...
<?php if (strlen($theend)) echo "[ <a class=\"q\" href=\"$theend\">Check Laters &#133;</a> ]"; ?>
		...
		<div style="margin: 1em auto 5px; width: 90%">
			<table style="width: 100%"><tr>
				<td style="text-align: left" width="25%">
					[ <a id="prevButton" class="q" onclick="javascript:ss_prev();">Previous</a> ]
					<!--script>
					document.getElementById("prevButton").addEventListener('click', ss_prev, false);
					</script-->
				</td><td style="text-align: center" width="50%">
